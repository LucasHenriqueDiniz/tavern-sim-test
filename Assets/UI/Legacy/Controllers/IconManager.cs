    ...
    public static class IconManager
    {
        ...
        private static Texture2D ConvertSvgToTexture(string svgContent, string iconName)
        {
            ...
            try
            {
                ...
                {
                    // Garantir que usamos a raiz SceneNode correta (Scene.Root)
                    var rootNode = (sceneInfo.Scene != null && sceneInfo.Scene.Root != null) ? sceneInfo.Scene.Root : new SceneNode();
                    bounds = VectorUtils.SceneNodeBounds(rootNode);
                }
        ...
        public static void ClearCache()
        {
            ...
            {
                UnityEngine.Object.DestroyImmediate(_vectorMaterial);

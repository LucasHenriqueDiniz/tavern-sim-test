...
namespace TavernSim.UI
{
    ...
    public class HUDIntegrationExample : MonoBehaviour
    {
        ...
        private void SetupHUD()
        {
            ...
            hudController.BindSelection(selectionService);
            ...
            // Fire events demand specific agent instances in this example signature; using placeholders for now
            hudController.FireWaiterRequested += () => OnFireWaiter(null);
            hudController.FireCookRequested += () => OnFireCook(null);
            hudController.FireBartenderRequested += () => OnFireBartender(null);
            hudController.FireCleanerRequested += () => OnFireCleaner(null);
        }
        ...
        private void SetupStaffPanel()
        {
            ...
            {
                // staffPanelController = FindObjectOfType<StaffPanelController>(); // TODO: StaffPanelController não herda de MonoBehaviour
            }
            ...
            if (staffPanelController != null)
            {
                ...
                // staffPanelController.RefreshAllStaffLists(); // TODO: Método não existe
            }
        }

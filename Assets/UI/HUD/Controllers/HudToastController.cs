...
namespace TavernSim.UI
{
    ...
    public sealed class HudToastController : MonoBehaviour
    {
        ...
        public void Initialize(IEventBus eventBus, VisualElement root)
        {
            _eventBus = eventBus;
            AttachTo(root);
        }
        ...
        public void ShowToast(string message, ToastType type = ToastType.Info)
        {
            ...
            {
                ToastType.Info => GameEventSeverity.Info,
                ToastType.Success => GameEventSeverity.Success,
                ToastType.Warning => GameEventSeverity.Warning,
                ToastType.Error => GameEventSeverity.Error,
                _ => GameEventSeverity.Info
            };
